...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/24 15:19:41 by avallet           #+#    #+#             */
/*   Updated: 2024/01/24 16:05:29 by avallet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (PRINT_MSG == 1)
		std::cout <<  "Converter assignment operator overload called."  << std::endl;
...
bool	Converter::checkConvChar(void) const
{
...
bool	Converter::checkConvInt(void) const
{
